...
public class MedicineActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomNav.setOnNavigationItemSelectedListener(new MedicineActivity.ItemSelectListener());
    }
    ...
    private class ItemSelectListener implements BottomNavigationView.OnNavigationItemSelectedListener{
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
            ...
            switch (menuItem.getItemId()) {
                case R.id.nav_home:
                    transaction.replace(R.id.madicFrameLayout, homeFragment).commitAllowingStateLoss();
                    break;

                case R.id.nav_shop:
                    transaction.replace(R.id.madicFrameLayout, shopFragment).commitAllowingStateLoss();
                    break;

                case R.id.nav_cart:
                    transaction.replace(R.id.madicFrameLayout, cartFragment).commitAllowingStateLoss();
                    break;
